...
public class NestedCategoryListFragmentNew
        extends BaseMultiLevelListFragment
    ...
    private int mLayout;
    private int mIdGroupChecked = BaseMultiLevelListFragment.INVALID_POSITION;

    private List<Category> mCategories;
    private String mCurFilter;

    public NestedCategoryListFragmentNew(Context context) {
        super(context);
        assert 1 == 2; // Todo: Why my class require constructor, while accountlistfragment not?
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        */
        mLayout = R.layout.nested_category_list_fragment; // Todo: import
...
//        int type = ExpandableListView.getPackedPositionType(info.packedPosition);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (getListAdapter() != null && getListAdapter().getGroupCount() > 0) {
            outState.putInt(KEY_ID_GROUP, ((CategoryExpandableListAdapter) getListAdapter()).getIdGroupChecked());
